...
export function DataProvider({ children }) {
    ...
    const [games, setGamesState] = useState(() => {
        try {
            const v = localStorage.getItem("dukkank_games_inventory_v59_custom_picc_covers");
            if (v !== "loaded_52") {
                localStorage.setItem("dukkank_games_inventory_v59_custom_picc_covers", "loaded_52");
